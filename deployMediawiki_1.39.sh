...
# 3.7.1
git clone --depth 1 -b $1 --depth 1 https://gerrit.wikimedia.org/r/mediawiki/extensions/LinkedWiki.git
# cd LinkedWiki
# git review -d XXXXXX
# cd ..
git clone --depth 1 -b 2.0.1 https://github.com/BorderCloud/NamespaceData.git
git clone  --branch 2.1.1 --depth 1 https://gerrit.wikimedia.org/r/mediawiki/extensions/PushAll.git
