### Build
```
docker build -f docker/rockylinux-apache-php8-mariadb-rdfunit/Dockerfile  -t rockylinux-apache-php8-mariadb-rdfunit . 
```

### Build without cache
```
docker build  --rm --no-cache -f docker/rockylinux-apache-php8-mariadb-rdfunit/Dockerfile  -t rockylinux-apache-php8-mariadb-rdfunit . 
```
...
docker run --privileged --cgroupns=host -tid \
        ...
        rockylinux-apache-php8-mariadb-rdfunit
```
